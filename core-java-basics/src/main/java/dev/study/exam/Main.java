...
public class Main {
    public static void main(String[] args) {
        ...
        // 주문번호로 검색
        System.out.println("\n주문 검색 (주문 번호 1):");
        Order foundOrder = orderManager.searchOrder(3);
        if (foundOrder != null) {
            System.out.println("고객: " + foundOrder.customerName() +
                    ", 상품: " + foundOrder.productList().stream()
        ...
        // 상품 이름으로 검색
        System.out.println("\n상품 이름 검색: ");
        Product foundProduct = orderManager.searchProduct("Phone");
        if(foundProduct != null) {
            System.out.println("상품이름: " + foundProduct.productName()
                    + ", 상품가격: " + foundProduct.price());
        }
        ...
        if(foundProduct2 != null) {
            System.out.println("상품 이름: " + foundProduct2.productName()
                    + ", 상품가격: " + foundProduct2.price());
        }
